...
export const adminOnly=(req,res,next)=>{
    ...
    try {
        ...
        // Check if the decoded token contains admin email that matches environment variable
        if(req.admin.email === process.env.ADMIN_EMAIL || req.admin.role === "admin"){
            // If admin credentials are valid, proceed to the next middleware or route handler
            next();
        } else {
